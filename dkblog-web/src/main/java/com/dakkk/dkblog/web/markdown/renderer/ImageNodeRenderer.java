package com.dakkk.dkblog.web.markdown.renderer;
 ...
 * @Author dakkk
 * Description: 用于给MD文章中的图片显示图片的描述
 */
public class ImageNodeRenderer implements NodeRenderer {
    ...
    public void render(Node node) {
        ...
        if (Objects.nonNull(lastChild) && lastChild instanceof ImageAttributes) {
            ...
            if (Objects.nonNull(imageAttributes)
                    && !CollectionUtils.isEmpty(imageAttributes.getAttributes())) {
